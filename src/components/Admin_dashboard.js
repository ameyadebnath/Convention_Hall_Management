   ...
   render(){
    return (
            ...
            <div >
                ...
                <Link className="second" to="/" style={{ textDecoration: 'none' }}> Add_New_Employee</Link>
                <Link className="second" to="/" style={{ textDecoration: 'none' }}> Add_New_Merchant</Link>
                <Link className="second" to="/" style={{ textDecoration: 'none' }}> Calculate_Payment_Of_Merchant</Link>
